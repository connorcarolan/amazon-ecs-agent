...
| `ECS_CONTAINER_INSPECT_TIMEOUT` | 10m | Timeout before giving up on inspecting a container. Minimum value is 10s. If user sets a value below minimum it will be set to min. | 30s | 30s |
